...
public class Battleship {
    ...
    public void play() {
        ...
        do {
            if (shoot(player1, player2)) break;
            promptEnterKey();
            if (shoot(player2, player1)) break;
            promptEnterKey();
        } while (true);
    }
    ...
    private boolean shoot(Player player, Player opponent) {
        ...
        char[][] opponentField = opponent.getBattlefield().getField();
        ...
        do {
            ...
            if (shotCoordinate.matches("[a-jA-J]10" + "|[a-jA-J][0-9]")) {
                ...
                if (opponentField[coordinate[0]][coordinate[1]] == ('~')) {
                    opponentField[coordinate[0]][coordinate[1]] = 'M';
                    System.out.println("\nYou missed!");
                } else if (opponentField[coordinate[0]][coordinate[1]] == 'O' ||
    ...
    private void setShipPositions(Player player) {
        ...
        for (Ship ship : player.getShips()) {
            char[][] field = player.getBattlefield().getField();
            String position;
            String[] coordinates;
                ...
                if (position.matches("[a-zA-Z]10\\s+[a-zA-Z]10" +
                    ...
                    if (pos[0] == pos[2]) {
                        for (int i = 0; i < ship.getLength(); i++) {
                            if (pos[0] == 10 && pos[1] != 10 && pos[1] + i != 10) {
                                if (field[pos[0]][pos[1] + i - 1] == 'O' ||
                                        field[pos[0]][pos[1] + i + 1] == 'O'||
                                        field[pos[0] - 1][pos[1] + i] == 'O'
                                ) {
                    ...
                    if (pos[1] == pos[3]) {
                        for (int i = 0; i < ship.getLength(); i++) {
                            //Check if the ship would be too close to another ship
                            if (pos[1] == 10 && pos[0] != 0) {
                                if (field[pos[0] + i - 1][pos[1]] == 'O' ||
                                        field[pos[0] + i + 1][pos[1]] == 'O' ||
                                        field[pos[0] + i][pos[1] - 1] == 'O'
                                ) {
                                    System.out.println("\nError! You placed it too close to another one. Try again:\n");
                                    correctInput = false;
                                }
                            ...
                            if (pos[1] != 10 && pos[0] != 10 && pos[1] - 1 >= 0 && pos[1] + 1 <= 10 &&
                                ...
                                if (player.getBattlefield().getField()[pos[0] + i - 1][pos[1]] == 'O' ||
                                        field[pos[0] + i + 1][pos[1]] == 'O' ||
                                        field[pos[0] + i][pos[1] - 1] == 'O' ||
                                        field[pos[0] + i][pos[1] + 1] == 'O'
                                ) {
